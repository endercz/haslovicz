...
// Test for db
$db = new mysqli("127.0.0.1","haslovi.cz","SqUGe7od","haslovicz1");
...
$myemail = "info@haslovi.cz"; // Replace with your email
...
echo 'Thank you for your submission.  The result of the query is: $result . Please <a href="index.html">Click here to return to our homepage.';
